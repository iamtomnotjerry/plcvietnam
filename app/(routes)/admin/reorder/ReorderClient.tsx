...
export function ReorderClient() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground mb-2">Sắp xếp thứ tự</h1>
        <p className="text-muted-foreground">Kéo thả để sắp xếp thứ tự hiển thị trong cây chủ đề</p>
      </div>
      ...
      {isSaving && (
        <div className="mb-4 p-3 bg-primary/10 text-primary rounded-md">Đang lưu thứ tự...</div>
      )}
      ...
      {activeTab === 'fields' && (
        <div>
          <p className="text-sm text-muted-foreground mb-4">
            Kéo thả để sắp xếp thứ tự các lĩnh vực
          </p>
          {isLoading ? (
      ...
      {activeTab === 'categories' && (
        <div>
          <div className="mb-4">
            <label className="block text-sm font-medium text-foreground mb-2">Chọn lĩnh vực</label>
            <select
      ...
      {activeTab === 'posts' && (
        <div>
          ...
          {selectedCategoryId && (
            <>
              <p className="text-sm text-muted-foreground mb-4">
                Kéo thả để sắp xếp thứ tự các bài viết
              </p>
              {isLoading ? (
                <div className="text-center py-8 text-muted-foreground">Đang tải...</div>
              ) : posts.length === 0 ? (
