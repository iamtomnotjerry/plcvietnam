...
describe('PostPage', () => {
  ...
  describe('generateStaticParams', () => {
    it('generates params for all field/category/post combinations', async () => {
      ...
      expect(params).toEqual([
        { fieldSlug: 'plc', categorySlug: 'ladder-logic', postSlug: 'intro-ladder' },
      ]);
  ...
  describe('generateMetadata', () => {
    it('generates metadata for valid post with SEO data', async () => {
      ...
      const metadata = await generateMetadata({
        params: Promise.resolve({ fieldSlug: 'plc', categorySlug: 'ladder-logic', postSlug: 'intro-ladder' }),
      });
    ...
    it('generates fallback metadata for invalid post', async () => {
      ...
      const metadata = await generateMetadata({
        params: Promise.resolve({ fieldSlug: 'invalid', categorySlug: 'invalid', postSlug: 'invalid' }),
      });
  ...
  describe('PostPage component', () => {
    ...
    it('passes correct props to PostDetail component', async () => {
      ...
      expect(screen.getByTestId('post-detail')).toBeInTheDocument();
      expect(contentRepository.getPostBySlug).toHaveBeenCalledWith('plc', 'ladder-logic', 'intro-ladder');
    });
  });
});
