    ...
    <section id="recent-posts" className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2 className="text-3xl font-semibold tracking-tight text-foreground md:text-4xl" style={{ fontFamily: 'var(--font-serif), ui-serif, Georgia, serif' }}>
              Bài viết mới nhất
            </h2>
            <p className="mt-2 text-muted-foreground">Cập nhật gần đây từ blog.</p>
          </div>
          <Link
            href="/posts"
