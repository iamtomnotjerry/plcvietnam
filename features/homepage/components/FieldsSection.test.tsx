...
describe('FieldsSection', () => {
  ...
  it('renders post counts for each field', () => {
    ...
    expect(screen.getByText('45 bài viết')).toBeInTheDocument();
    expect(screen.getByText('32 bài viết')).toBeInTheDocument();
    expect(screen.getByText('28 bài viết')).toBeInTheDocument();
  });
