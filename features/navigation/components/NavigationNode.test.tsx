...
describe('NavigationNode', () => {
  ...
  describe('Expand/Collapse Functionality', () => {
    ...
    it('should hide children when collapsed', () => {
      ...
      const childrenWrapper = screen.getByText('Basics').closest('div')?.parentElement?.parentElement;
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle node with empty children array', () => {
      ...
      // Should not render chevron or children container
      const { container } = render(
        <NavigationNode
          node={nodeWithEmptyChildren}
          expandedIds={new Set()}
