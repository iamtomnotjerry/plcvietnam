 ...
 */
const postArbitrary = (availableTags: Tag[], availableCategories: Category[]) => fc.record({
  id: fc.uuid(),
 ...
 */
const testScenarioArbitrary = fc.array(tagArbitrary, { minLength: 0, maxLength: 10 })
  .chain(tags => 
