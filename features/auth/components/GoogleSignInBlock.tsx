...
export function GoogleSignInBlock() {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-3 rounded-xl border border-border/80 bg-background/80 py-3 text-sm font-semibold text-foreground shadow-sm backdrop-blur-sm transition-[transform,box-shadow,colors,border-color] duration-200 hover:-translate-y-px hover:border-primary/35 hover:bg-muted/70 hover:shadow-md active:translate-y-0 dark:bg-card/50"
    >
      <GoogleLogo />
